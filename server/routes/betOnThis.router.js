...
router.post('/', (req, res) => {
    const bet = req.body;
    const queryText = `
    INSERT INTO "user_auto_bets" ("user_id", "score_id", "chosen_team", "global_team_id", "chosen_moneyline", "week", "bet_amount")
    VALUES ($1, $2, $3, $4, $5, $6, $7);`;

    const queryValues = [ bet.user_id, bet.score_id, bet.chosen_team, bet.global_team_id, bet.chosen_moneyline, bet.week, bet.bet_amount ];
